            ...
            <div class="p-3 bg-gray-300 rounded">
                <form action="{{ url('/checkouts') }}" method="POST">
                    ...
                    <div class="pb-3">
                        ...
                        <input type="text" id="phone" name="phone" placeholder="Enter your available phone number" value="{{ old('phone') }}"
                    ...
                    <div class="pb-3">
                        ...
                        <input type="text" id="direction" name="direction" placeholder="Eg - Near Sule bus stop" value="{{ old('direction') }}"
                    ...
                    <div class="pb-3">
                        <label for="card_no" class="block mb-2 text-md font-medium text-gray-900 dark:text-black">Card
                            No</label>
                        <input type="text" id="card_no" name="card_no" placeholder="Enter your card number" value="{{ old('card_no') }}"
                    ...
                    <div class="pb-3">
                        <label for="exp_date" class="block mb-2 text-md font-medium text-gray-900 dark:text-black">Expire
                            Date</label>
                        <input type="date" id="exp_date" name="exp_date" placeholder="Enter your expire date" value="{{ old('exp_date') }}"
                    ...
                    <div class="pb-3">
                        ...
                        <input type="password" id="cvv" name="cvv" placeholder="Enter your CVV" value="{{ old('cvv') }}"
                    ...
                    <div class="pb-3">
                        ...
                        <input type="password" id="vat" name="vat" value="{{ old('vat') }}"
                    ...
                    <div class="pb-3">
                        <label for="grand_total" class="block mb-2 text-md font-medium text-gray-900 dark:text-black">Grand
                            Total</label>
                        <input type="integer" id="grand_total" name="grand_total" value="{{ old('grand_total') }}"
