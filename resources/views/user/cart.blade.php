    ...
    <div class="container mx-auto pt-20 pb-5 px-4">
        <div class="pb-3 md:float-right">
            ...
            <div class="relative mt-1">
                ...
                <input type="text" id="table-search" name="search" placeholder="Search for items"
        ...
        @endif
        <div class="relative overflow-x-auto shadow-md clear-both">
