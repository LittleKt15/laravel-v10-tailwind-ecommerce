...
@section('content')
    ...
    <div class="bg-gray-900 text-white text-center py-3 px-3 md:px-0">
        <a href="#">
                    ...
                    <div
                        ...
                        <div class="p-5">
                            ...
                            <a href="#"
                                ...
                                Add to Cart
                                <svg fill="none" class="w-4 h-4 ml-2 -mr-1" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
