            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <a href="{{ url('/index') }}" class="flex ml-2 md:mr-24">
                        <img src="https://m.media-amazon.com/images/S/aplus-media/sc/0a86c50b-5b09-454d-9e0e-4acaf4ad1c40.__CR0,0,500,500_PT0_SX300_V1___.jpg" class="h-8 mr-3" alt="FlowBite Logo" />
                        <span
                                ...
                                <form action="{{ route('logout') }}" method="post">
                                    ...
                                    <li>
                                        <button onclick="return confirm('Are you sure you want to logout?')"
                                            class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white w-full text-start">Sign
                                            out</button>
                                    </li>
                                </form>
                            </ul>
